...
// Source: plugins/manager/interface.go
...
func (m *MockPluginManager) Plugins() (map[plugins.PluginType]*plugins.Plugin, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Plugins")
	ret0, _ := ret[0].(map[plugins.PluginType]*plugins.Plugin)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
